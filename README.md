...
![Guided Querying overview](static/images/vidautocomplete-diagram.gif)
...
Implementation details, scripts, and the FastAPI demo that powers the site now live in `src/`.
